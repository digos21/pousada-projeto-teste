...
let btnLeft = document.getElementById('atividade-prev-btn');
let btnRight = document.getElementById('atividade-next-btn');

//Aqui estamos atribuindo o container principal e o slider com os cards
let slider = document.querySelector('.atividades-container .atividades-slider');
