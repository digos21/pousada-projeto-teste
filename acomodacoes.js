...
let slider = document.querySelector('.acomodacoes-container .slider');
...
//Aqui estamos adicionando as funções dos botões do html
let botaoLeft = document.getElementById('atividade-prev-btn');
let botaoRight = document.getElementById('atividade-next-btn');
